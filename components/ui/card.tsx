...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-card text-card-foreground flex flex-col gap-0 rounded-2xl border border-ink-950/[0.075] py-5 shadow-[0_1px_2px_rgba(10,10,10,.03),0_10px_30px_rgba(10,10,10,.035)]",
        className
      )}
      {...props}
    />
